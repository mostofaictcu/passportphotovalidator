...
PASSPORT_STANDARDS = {
    ...
    "computed_from_standards": {
        "MIN_SHARPNESS": {
            ...
            "min": 150.32, "max": 968.21, "avg": 340.8,
...
class PassportPhotoValidatorV3:
    ...
    def check_lighting(self):
        ...
        # - Std dev: 47.9 - 68.5 (comfortable: < 120)
        ...
        lighting_even = std_dev < 120  # Allowing for some variance due to shadows, etc.
        ...
        self.validation_results['lighting'] = {
            ...
            'threshold': 'std_dev < 120 (comfortable)',
            'constraints': {
